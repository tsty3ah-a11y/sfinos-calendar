...
-- ── SCHEDULE (40 route-days for 2026) ──
DO $$
DECLARE
  rid UUID;
  cid UUID;
BEGIN
  ...
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-03-03', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 2';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 1 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-03-10', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 3';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 1 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-03-17', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 4';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 1 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-03-24', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΕΥΒΟΙΑ';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 1 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-03-31', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 1';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 2 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-04-07', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 2';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 2 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-04-16', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 3';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 2 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-04-21', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 4';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 2 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-04-28', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΕΥΒΟΙΑ';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 2 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-05-05', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 1';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 3 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-05-13', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 2';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 3 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-05-19', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 3';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 3 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-05-26', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 4';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 3 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-06-02', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΕΥΒΟΙΑ';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 3 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-06-09', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 1';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 4 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-06-16', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 2';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 4 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-06-24', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 3';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 4 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-06-29', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 4';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 4 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-07-07', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΕΥΒΟΙΑ';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 4 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-07-15', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 1';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 5 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-07-21', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 2';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 5 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-07-29', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 3';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 5 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-09-02', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 4';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 5 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-09-08', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΕΥΒΟΙΑ';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 5 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-09-15', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 1';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 6 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-09-22', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 2';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 6 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-09-29', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 3';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 6 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-10-07', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 4';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 6 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-10-13', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΕΥΒΟΙΑ';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 6 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-10-20', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 1';
  ...
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 2';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 7 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-11-04', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 3';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 7 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-11-10', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 4';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 7 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-11-18', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΕΥΒΟΙΑ';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 7 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-11-25', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 1';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 8 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-12-03', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 2';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 8 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-12-09', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 3';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 8 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-12-15', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΑΘΗΝΑ 4';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 8 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-12-22', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
  SELECT id INTO rid FROM routes WHERE name = 'ΕΥΒΟΙΑ';
  SELECT id INTO cid FROM cycles WHERE cycle_number = 8 AND year = 2026;
  INSERT INTO schedule (visit_date, route_id, cycle_id) VALUES ('2026-12-29', rid, cid) ON CONFLICT (visit_date) DO NOTHING;
END $$;
